...
def find_project_root():
    ...
    # 3Fallback to old behavior (project root = two levels up)
...
class SpellCheckSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        self.custom_words = {
            ...
            "CTE", "NJ", "PCTI", "async", "div", "etc", "max", "noreferrer", "rschooltoday", "submenu", "svg"

        }

        # Load your custom dictionary into spellchecker
        ...
        # Connect spider_closed to Scrapy’s closing signal
    ...
    def parse(self, response):
        ...
        # Normalize words and filter out proper nouns or weird tokens
        words = []
        for w in text.split():
            stripped = w.strip(".,!?()[]{}:;\"'")
            ...
            # Skip short, weird, or numeric tokens
    ...
    def spider_closed(self, spider):
        ...
        html = template.render(pages=sorted_results, total_pages=self.page_count)
